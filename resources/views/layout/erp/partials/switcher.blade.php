...
<div class="offcanvas-body">
    <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="d-flex flex-wrap align-items-center switcher-style">
                        <div class="form-check switch-select menu-img-select m-2">
                            ...
                            <div class="bg-img-container">
                                <img src="{{ asset('assets') }}/images/menu-bg-images/bg-img1.jpg" alt="">
                            </div>
                        </div>
                        <div class="form-check switch-select menu-img-select m-2">
                            ...
                            <div class="bg-img-container">
                                <img src="{{ asset('assets') }}/images/menu-bg-images/bg-img2.jpg" alt="">
                            </div>
                        </div>
                        <div class="form-check switch-select menu-img-select m-2">
                            ...
                            <div class="bg-img-container">
                                <img src="{{ asset('assets') }}/images/menu-bg-images/bg-img3.jpg" alt="">
                            </div>
                        </div>
                        <div class="form-check switch-select menu-img-select m-2">
                            ...
                            <div class="bg-img-container">
                                <img src="{{ asset('assets') }}/images/menu-bg-images/bg-img4.jpg" alt="">
                            </div>
                        </div>
                        <div class="form-check switch-select menu-img-select m-2">
                            ...
                            <div class="bg-img-container">
                                <img src="{{ asset('assets') }}/images/menu-bg-images/bg-img5.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-between canvas-footer flex-wrap">
            ...
            <a href="https://1.envato.market/MGEaN" target="_blank" class="btn btn-secondary">Our
                Portfolio</a>
